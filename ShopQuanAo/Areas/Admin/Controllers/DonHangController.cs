    ...
    public class DonHangController : Controller
    {
        ...
        public IActionResult Index(string searchKeyword, int? page)
        {
            ...
            var query = _context.DonHangs
                ...
                .Include(d => d.GiaoDichThanhToans) // [ĐÃ THÊM]: Load thêm dữ liệu Giao dịch VNPay
                .AsNoTracking();
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var donHang = await _context.DonHangs
                ...
                .Include(d => d.GiaoDichThanhToans) // Load thêm giao dịch ở chi tiết
        ...
        public async Task<IActionResult> InHoaDon(int? id)
        {
            ...
            var donHang = await _context.DonHangs
                ...
                // BẮT BUỘC PHẢI THÊM DÒNG NÀY ĐỂ ĐỌC ĐƯỢC THANH TOÁN VNPAY
